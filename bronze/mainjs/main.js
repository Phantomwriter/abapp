...
function toggleControls(n){
	...
	case "off":
		...
		go('addNew').style.display ="inline";//This was added on 8/30-Noticed there was only the one in the "case on" section directly above this section
		break;
	default:
		return false;
	}
...
function getData(){
 ...
 //Getting image for the right category
    ...
    var setSrc = newImg.setAttribute("src", "textAndMobileAppImages/" + pickATheme + ".png");
...
//Local variables and function calls
		var contactGroups =["--pickATheme--", "Fun", "Education", "Work", "I do it all!"],
			deviceValue,				
			selectValue = "No",
			errMsg = go('errors');
